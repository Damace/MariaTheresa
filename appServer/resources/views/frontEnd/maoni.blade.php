                                    ...
                                    @if (!empty($maoni))
                                        @foreach ($maoni as $data)
                                            <tr>
                                                ...
                                                <td align="center"><i class="bi bi-eye me-1" style="color:blue"
                                                        title="Pre View" data-bs-toggle="modal"
                                                        data-bs-target="#basicModal{{ $data->id }}"></i></a>
                                                    &nbsp&nbsp&nbsp </td>
                                                <td><a href="{{ url('delete_maoni/' . $data->id) }}"><i
                                                            class="bi bi-trash me-1" style="font-weight:bold,color:red"
                                                            title="Delete"></i></a></td>
