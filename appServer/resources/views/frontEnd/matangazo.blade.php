    ...
    <main id="main" class="main">
        ...
        <div class="card">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                            type="button" role="tab" aria-controls="home" aria-selected="true">Matangazo</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation" novalidate action="{{ url('tangazo') }}"
                                    method="POST">
                                    @csrf
                                    @method('post')
                                    ...
                                    <div class="row mb-3" style="width:800px">
                                        <label for="inputDate" class="col-sm-2 col-form-label"><small>Jumapili ya
                                                Tarehe</small></label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-3" style="width:800px">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="dominika"
                                                placeholder="Dominika ya pili ya Pasaka" value="">
                                    ...
                                    <div class="row mb-3" style="width:800px">
                                        <label for="inputPassword"
                                            class="col-sm-2 col-form-label"><small>Maelezo</small></label>
                                        <div class="col-sm-10">
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <form class="row g-3 needs-validation" novalidate action="{{ url('tangazo_atachments') }}"
